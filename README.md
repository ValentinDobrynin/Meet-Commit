...
- 📊 **Система scoring** с частотой, встречами и свежестью
- 🎯 **People Miner v2** с интерактивными карточками и батч-операциями
...
```bash
# People Miner v2 (рекомендуется)
/people_miner2           # Интерактивный интерфейс с UX
...
- `/people_miner` - Интерактивная верификация кандидатов людей (v1)
- `/people_miner2 [freq|date]` - People Miner v2 с улучшенным UX
...
- [Полный гайд по тегам](docs/user_guide_tagging.md) - **ГЛАВНОЕ РУКОВОДСТВО** для пользователей бота
- [Управление людьми](docs/people_management.md) - работа со словарем участников
- [Система тегирования](docs/tagging_system.md) - техническая документация тегов
