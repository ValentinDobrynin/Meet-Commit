...
- Принятые решения и договорённости: "решили", "договорились", "зафиксировали", "согласовали", "утвердили", "установили" + конкретный результат.
  Создавай как follow-up коммит с assignees=[] и флагом "decision", confidence≈0.6.
  Формулируй как задачу-напоминание: "проследить за выполнением: X" или "зафиксировать в документах: X".
...
- "decision" — принятое решение/договорённость без назначенного исполнителя.
