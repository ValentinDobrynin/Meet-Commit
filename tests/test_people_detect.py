...
def temp_dict_dir():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        with patch("app.core.people_store.DICT_DIR", temp_path), \
            ...
            mock_stopwords.return_value = {"проект", "бюджет", "ceo", "meeting", "январь", "март", "pm"}
            yield temp_path
...
def test_mine_alias_candidates_length_limits(mock_people_data):
    ...
    assert "VeryLongNameThatExceedsFiftyCharactersAndShouldNotBeDetected" not in result  # слишком длинное
