...
class TestPeopleJsonOperations:
    ...
    def test_load_people_json_file_not_found(self):
        ...
        with patch('app.bot.handlers_people_admin.PEOPLE_JSON_PATH', Path('/nonexistent/file.json')):
            result = load_people_json()
            assert result == []
...
class TestSuggestedAliases:
    ...
    def test_get_suggested_aliases_limit(self):
        ...
        candidates = {
            "candidates": {f"John{i}": 10 - i for i in range(15)}
        }
...
class TestHandlers:
    ...
    async def test_cmd_people_admin_success(self, mock_load, mock_admin_check, mock_message, mock_state):
    ...
    @patch('app.bot.handlers_people_admin.settings.is_admin')
    async def test_cmd_people_admin_no_permissions(self, mock_admin_check, mock_message, mock_state):
    ...
    async def test_process_add_person_name_success(self, mock_save, mock_load, mock_message, mock_state):
    ...
    @patch('app.bot.handlers_people_admin.load_people_json')
    @patch('app.bot.handlers_people_admin.save_people_json')
    async def test_process_add_person_aliases_success(self, mock_save, mock_load, mock_message, mock_state):
    ...
    @patch('app.bot.handlers_people_admin.load_people_json')
    @patch('app.bot.handlers_people_admin.save_people_json')
    async def test_process_add_person_aliases_skip(self, mock_save, mock_load, mock_message, mock_state):
...
class TestIntegration:
    ...
    def test_full_workflow_add_person_with_suggestions(self, mock_candidates_path, mock_people_path):
