...
def _review_candidates(top_k: int = 20) -> None:
    ...
    for alias, frequency in sorted_candidates:
        ...
        while True:
            ...
            new_person = {"name_en": final_name_en, "aliases": aliases_list}
...
def main() -> None:
    ...
    parser.add_argument("--stats", action="store_true", help="Показать статистику кандидатов")

    parser.add_argument("--clear", action="store_true", help="Очистить словарь кандидатов")
